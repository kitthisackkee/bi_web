            ...
            <form method="POST" action="{{route('service.update', $service->id)}}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label for="name">{{__('blog.icon')}}</label>
                        <input type="text" class="form-control {{ $errors->has('icon') ? ' is-invalid' : '' }}" name="icon" value="{{$service->icon}}" placeholder="{{__('blog.icon')}}">
                        @if ($errors->has('icon'))
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea type="text" class="form-control summernote {{ $errors->has('short_des_la') ? ' is-invalid' : '' }}" name="short_des_la" placeholder="{{__('lang.short_des')}}"> {{$service->short_des_la}}</textarea>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <textarea type="text" class="form-control summernote {{ $errors->has('short_des_en') ? ' is-invalid' : '' }}" name="short_des_en" placeholder="{{__('lang.short_des')}}"> {{$service->short_des_en}}</textarea>
