                      ...
                      <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" value="{{$book->name}}" placeholder="{{__('lang.name')}}{{__('lang.books')}}">
                            </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <textarea name="note" id="note" class="form-control">{{$book->note}}</textarea>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                              ...
                              <select class="form-control" name="status">
                                  <option value="1" {{$book->status == 1 ? 'selected' : ''}}>{{ __('blog.active') }}</option>
                                  <option value="0" {{$book->status == 0 ? 'selected' : ''}}>{{ __('blog.inactive') }}</option>
                              </select>
                          </div>
                          </div>
                      </div>
