    ...
    <div class="container-fluid">
        <div class="col-lg-12">
          <div class="card card-default">
            ...
            <form method="POST" action="{{route('export_doc.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            ...
                            <select class="form-control" name="showweb" style="width: 100%;">               
                                <option value="0" selected>{{__('blog.false')}}</option>
                                <option value="1">{{__('blog.true')}}</option>
                            </select>
                          </div>
                        </div>
                      </div>
